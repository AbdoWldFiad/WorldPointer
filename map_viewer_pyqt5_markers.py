from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QGraphicsScene, QGraphicsView, QGraphicsPixmapItem, QGraphicsEllipseItem, QPushButton, QColorDialog, QDockWidget
...
class MapViewer(QMainWindow):
    def __init__(self):
        ...
        # Create a toggle button for the sidebar with hamburger icon
        self.hamburger_icon = QPixmap('hamburger_icon.png')  # Ensure this file exists
        self.toggle_button = QPushButton(QIcon(self.hamburger_icon), '', self)
        self.toggle_button.setFixedSize(30, 30)
        self.toggle_button.clicked.connect(self.toggle_sidebar)

        # Ensure button updates position on resize
    ...
    def on_resize(self, event):
        # Update the toggle button's position when the window is resized
        self.toggle_button.setGeometry(self.width() - 40, 10, 30, 30)
